module {
  cfx.func @example_7(%arg0: memref<1000xi32>, %arg1: memref<1000xi32>, %arg2: memref<1000xi32>, %arg3: memref<1000xi32>, %arg4: memref<1000xi32>, %arg5: memref<1000xi32>, %arg6: memref<1000xi32>, %arg7: memref<1000xi32>) attributes {handshake.name = "func0"} {
    ...
    %14 = arith.muli %13, %10 {cfx.bb = 1 : i64, handshake.name = "muli0", sched_var = #cfx.sched_var<0>} : i32
    %15 = arith.index_cast %11 {cfx.bb = 1 : i64, handshake.name = "index_cast2", sched_var = #cfx.sched_var<0>} : i64 to index
    memref.store %14, %arg0[%15] {cfx.bb = 1 : i64, handshake.mem_interface = #handshake.mem_interface<LSQ: 0>, handshake.name = "store2", sched_var = #cfx.sched_var<0>} : memref<1000xi32>
    ...
    %22 = arith.muli %21, %18 {cfx.bb = 1 : i64, handshake.name = "muli1", sched_var = #cfx.sched_var<0>} : i32
    %23 = arith.index_cast %19 {cfx.bb = 1 : i64, handshake.name = "index_cast5", sched_var = #cfx.sched_var<0>} : i64 to index
    memref.store %22, %arg1[%23] {cfx.bb = 1 : i64, handshake.mem_interface = #handshake.mem_interface<LSQ: 0>, handshake.name = "store5", sched_var = #cfx.sched_var<0>} : memref<1000xi32>
    ...
    %30 = arith.muli %29, %26 {cfx.bb = 1 : i64, handshake.name = "muli2", sched_var = #cfx.sched_var<0>} : i32
    %31 = arith.index_cast %27 {cfx.bb = 1 : i64, handshake.name = "index_cast8", sched_var = #cfx.sched_var<0>} : i64 to index
    memref.store %30, %arg2[%31] {cfx.bb = 1 : i64, handshake.mem_interface = #handshake.mem_interface<LSQ: 0>, handshake.name = "store8", sched_var = #cfx.sched_var<0>} : memref<1000xi32>
    ...
    %38 = arith.muli %37, %34 {cfx.bb = 1 : i64, handshake.name = "muli3", sched_var = #cfx.sched_var<0>} : i32
    %39 = arith.index_cast %35 {cfx.bb = 1 : i64, handshake.name = "index_cast11", sched_var = #cfx.sched_var<0>} : i64 to index
    memref.store %38, %arg3[%39] {cfx.bb = 1 : i64, handshake.mem_interface = #handshake.mem_interface<LSQ: 0>, handshake.name = "store11", sched_var = #cfx.sched_var<0>} : memref<1000xi32>
    ...
    %46 = arith.muli %45, %42 {cfx.bb = 1 : i64, handshake.name = "muli4", sched_var = #cfx.sched_var<0>} : i32
    %47 = arith.index_cast %43 {cfx.bb = 1 : i64, handshake.name = "index_cast14", sched_var = #cfx.sched_var<0>} : i64 to index
    memref.store %46, %arg4[%47] {cfx.bb = 1 : i64, handshake.mem_interface = #handshake.mem_interface<LSQ: 0>, handshake.name = "store14", sched_var = #cfx.sched_var<0>} : memref<1000xi32>
    ...
    %54 = arith.muli %53, %50 {cfx.bb = 1 : i64, handshake.name = "muli5", sched_var = #cfx.sched_var<0>} : i32
    %55 = arith.index_cast %51 {cfx.bb = 1 : i64, handshake.name = "index_cast17", sched_var = #cfx.sched_var<0>} : i64 to index
    memref.store %54, %arg5[%55] {cfx.bb = 1 : i64, handshake.mem_interface = #handshake.mem_interface<LSQ: 0>, handshake.name = "store17", sched_var = #cfx.sched_var<0>} : memref<1000xi32>
    ...
    %62 = arith.muli %61, %58 {cfx.bb = 1 : i64, handshake.name = "muli6", sched_var = #cfx.sched_var<0>} : i32
    %63 = arith.index_cast %59 {cfx.bb = 1 : i64, handshake.name = "index_cast20", sched_var = #cfx.sched_var<0>} : i64 to index
    memref.store %62, %arg6[%63] {cfx.bb = 1 : i64, handshake.mem_interface = #handshake.mem_interface<LSQ: 0>, handshake.name = "store20", sched_var = #cfx.sched_var<0>} : memref<1000xi32>
    %64 = arith.addi %4, %7 {cfx.bb = 1 : i64, handshake.name = "addi0", sched_var = #cfx.sched_var<0>} : i32
    %65 = arith.cmpi ult, %64, %6 {cfx.bb = 1 : i64, handshake.name = "cmpi0", sched_var = #cfx.sched_var<0>} : i32
    %66 = cfx.cond_br cond = %65[when_true], input = %64 {cfx.bb = 1 : i64, handshake.name = "cond_br1", sched_var = #cfx.sched_var<0>} : i1, i32 -> i32
    %67 = cfx.cond_br cond = %65[when_true], input = %5 {cfx.bb = 1 : i64, handshake.name = "cond_br2", sched_var = #cfx.sched_var<0>} : i1, i0 -> i0
    %68 = cfx.cond_br cond = %65[when_false], input = %5 {cfx.bb = 1 : i64, handshake.name = "cond_br3", sched_var = #cfx.sched_var<0>} : i1, i0 -> i0
    cfx.return start = %68,  {cfx.bb = 2 : i64, handshake.name = "return1", sched_var = #cfx.sched_var<0>}
  }
}
