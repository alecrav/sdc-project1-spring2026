module {
  cfx.func @example_12(%arg0: memref<1000xf32>, %arg1: memref<1000xf32>) -> f32 attributes {handshake.name = "func0"} {
    ...
    %18 = arith.mulf %14, %17 {cfx.bb = 1 : i64, handshake.name = "mulf0", sched_var = #cfx.sched_var<0>} : f32
    %19 = arith.mulf %7, %18 {cfx.bb = 1 : i64, handshake.name = "mulf1", sched_var = #cfx.sched_var<0>} : f32
    %20 = arith.addi %6, %11 {cfx.bb = 1 : i64, handshake.name = "addi0", sched_var = #cfx.sched_var<0>} : i32
    %21 = arith.cmpf olt, %19, %10 {cfx.bb = 1 : i64, handshake.name = "cmpf0", sched_var = #cfx.sched_var<0>} : f32
    %22 = arith.cmpi ult, %20, %9 {cfx.bb = 1 : i64, handshake.name = "cmpi0", sched_var = #cfx.sched_var<0>} : i32
    %23 = arith.andi %21, %22 {cfx.bb = 1 : i64, handshake.name = "andi0", sched_var = #cfx.sched_var<0>} : i1
    %24 = cfx.cond_br cond = %23[when_true], input = %20 {cfx.bb = 1 : i64, handshake.name = "cond_br1", sched_var = #cfx.sched_var<0>} : i1, i32 -> i32
    %25 = cfx.cond_br cond = %23[when_true], input = %19 {cfx.bb = 1 : i64, handshake.name = "cond_br2", sched_var = #cfx.sched_var<0>} : i1, f32 -> f32
    %26 = cfx.cond_br cond = %23[when_true], input = %8 {cfx.bb = 1 : i64, handshake.name = "cond_br3", sched_var = #cfx.sched_var<0>} : i1, i0 -> i0
    %27 = cfx.cond_br cond = %23[when_false], input = %19 {cfx.bb = 1 : i64, handshake.name = "cond_br4", sched_var = #cfx.sched_var<0>} : i1, f32 -> f32
    %28 = cfx.cond_br cond = %23[when_false], input = %8 {cfx.bb = 1 : i64, handshake.name = "cond_br5", sched_var = #cfx.sched_var<0>} : i1, i0 -> i0
    cfx.return start = %28, %27 {cfx.bb = 2 : i64, handshake.name = "return1", sched_var = #cfx.sched_var<0>} : f32
  }
}
