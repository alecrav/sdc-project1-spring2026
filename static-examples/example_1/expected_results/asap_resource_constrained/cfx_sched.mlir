module {
  cfx.func @example_1(%arg0: memref<1000xi32>, %arg1: memref<1000xi32>, %arg2: memref<1000xi32>, %arg3: memref<1000xi32>) -> i32 attributes {handshake.name = "func0"} {
    ...
    %23 = arith.muli %19, %22 {cfx.bb = 1 : i64, handshake.name = "muli1", sched_var = #cfx.sched_var<2>} : i32
    %24 = arith.addi %16, %23 {cfx.bb = 1 : i64, handshake.name = "addi0", sched_var = #cfx.sched_var<6>} : i32
    %25 = arith.addi %6, %24 {cfx.bb = 1 : i64, handshake.name = "addi1", sched_var = #cfx.sched_var<7>} : i32
    ...
    %29 = cfx.cond_br cond = %27[when_true], input = %25 {cfx.bb = 1 : i64, handshake.name = "cond_br2", sched_var = #cfx.sched_var<8>} : i1, i32 -> i32
    %30 = cfx.cond_br cond = %27[when_true], input = %7 {cfx.bb = 1 : i64, handshake.name = "cond_br3", sched_var = #cfx.sched_var<1>} : i1, i0 -> i0
    %31 = cfx.cond_br cond = %27[when_false], input = %25 {cfx.bb = 1 : i64, handshake.name = "cond_br4", sched_var = #cfx.sched_var<8>} : i1, i32 -> i32
