module {
  cfx.func @example_1(%arg0: memref<1000xi32>, %arg1: memref<1000xi32>, %arg2: memref<1000xi32>, %arg3: memref<1000xi32>) -> i32 attributes {cfx.ii_map = {BB_1 = 1 : i32}, handshake.name = "func0"} {
