module {
  cfx.func @example_1(%arg0: memref<1000xi32>, %arg1: memref<1000xi32>, %arg2: memref<1000xi32>, %arg3: memref<1000xi32>) -> i32 attributes {handshake.name = "func0"} {
    ...
    %6 = cfx.phi %29, %3 {cfx.bb = 1 : i64, handshake.name = "phi1", sched_var = #cfx.sched_var<6>} : i32, i32 -> i32
    %7 = cfx.phi %30, %4 {cfx.bb = 1 : i64, handshake.name = "phi2", sched_var = #cfx.sched_var<6>} : i0, i0 -> i0
    ...
    %26 = arith.addi %5, %9 {cfx.bb = 1 : i64, handshake.name = "addi2", sched_var = #cfx.sched_var<6>} : i32
    %27 = arith.cmpi ult, %26, %8 {cfx.bb = 1 : i64, handshake.name = "cmpi0", sched_var = #cfx.sched_var<7>} : i32
    %28 = cfx.cond_br cond = %27[when_true], input = %26 {cfx.bb = 1 : i64, handshake.name = "cond_br1", sched_var = #cfx.sched_var<7>} : i1, i32 -> i32
    %29 = cfx.cond_br cond = %27[when_true], input = %25 {cfx.bb = 1 : i64, handshake.name = "cond_br2", sched_var = #cfx.sched_var<7>} : i1, i32 -> i32
    %30 = cfx.cond_br cond = %27[when_true], input = %7 {cfx.bb = 1 : i64, handshake.name = "cond_br3", sched_var = #cfx.sched_var<7>} : i1, i0 -> i0
    %31 = cfx.cond_br cond = %27[when_false], input = %25 {cfx.bb = 1 : i64, handshake.name = "cond_br4", sched_var = #cfx.sched_var<7>} : i1, i32 -> i32
    %32 = cfx.cond_br cond = %27[when_false], input = %7 {cfx.bb = 1 : i64, handshake.name = "cond_br5", sched_var = #cfx.sched_var<7>} : i1, i0 -> i0
    cfx.return start = %32, %31 {cfx.bb = 2 : i64, handshake.name = "return1", sched_var = #cfx.sched_var<0>} : i32
  }
}
