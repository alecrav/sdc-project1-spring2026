module {
  cfx.func @example_3(%arg0: memref<1000xi32>, %arg1: memref<1000xi32>) attributes {handshake.name = "func0"} {
    ...
    memref.store %14, %arg0[%16] {cfx.bb = 1 : i64, handshake.deps = #handshake<deps[["store3", 1, 0]]>, handshake.mem_interface = #handshake.mem_interface<LSQ: 0>, handshake.name = "store2", sched_var = #cfx.sched_var<5>} : memref<1000xi32>
    ...
    memref.store %4, %arg0[%18] {cfx.bb = 1 : i64, handshake.mem_interface = #handshake.mem_interface<LSQ: 0>, handshake.name = "store3", sched_var = #cfx.sched_var<6>} : memref<1000xi32>
