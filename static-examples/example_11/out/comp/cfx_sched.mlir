module {
  cfx.func @example_11(%arg0: memref<1000xi32>, %arg1: memref<1000xi32>) attributes {handshake.name = "func0"} {
    ...
    %11 = arith.index_cast %10 {cfx.bb = 1 : i64, handshake.name = "index_cast1", sched_var = #cfx.sched_var<0>} : i32 to index
    %12 = memref.load %arg0[%11] {cfx.bb = 1 : i64, handshake.deps = #handshake<deps[["store3", 1, 0]]>, handshake.mem_interface = #handshake.mem_interface<LSQ: 0>, handshake.name = "load1", sched_var = #cfx.sched_var<0>} : memref<1000xi32>
    ...
    memref.store %16, %arg0[%18] {cfx.bb = 1 : i64, handshake.deps = #handshake<deps[["load1", 1, 1]]>, handshake.mem_interface = #handshake.mem_interface<LSQ: 0>, handshake.name = "store3", sched_var = #cfx.sched_var<0>} : memref<1000xi32>
