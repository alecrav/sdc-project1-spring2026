module {
  cfx.func @example_2(%arg0: memref<1000xi32>, %arg1: memref<1000xi32>, %arg2: memref<1000xi32>, %arg3: memref<1000xi32>, %arg4: i32) -> i32 attributes {cfx.ii_map = {BB_1 = 1 : i32, BB_2 = 4 : i32}, handshake.name = "func0"} {
    ...
    %7 = cfx.phi %31, %3 {cfx.bb = 1 : i64, handshake.name = "phi1", sched_var = #cfx.sched_var<6>} : i32, i32 -> i32
    ...
    %39 = cfx.phi %62, %35 {cfx.bb = 2 : i64, handshake.name = "phi5", sched_var = #cfx.sched_var<3>} : i32, i32 -> i32
