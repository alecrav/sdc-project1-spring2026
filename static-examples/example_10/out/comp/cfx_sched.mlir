module {
  cfx.func @example_10(%arg0: memref<1000xi32>, %arg1: memref<1000xi32>) attributes {handshake.name = "func0"} {
    ...
    %10 = arith.extui %9 {cfx.bb = 1 : i64, handshake.name = "extui0", sched_var = #cfx.sched_var<0>} : i32 to i64
    %11 = arith.index_cast %10 {cfx.bb = 1 : i64, handshake.name = "index_cast0", sched_var = #cfx.sched_var<0>} : i64 to index
    %12 = memref.load %arg0[%11] {cfx.bb = 1 : i64, handshake.mem_interface = #handshake.mem_interface<LSQ: 0>, handshake.name = "load0", sched_var = #cfx.sched_var<0>} : memref<1000xi32>
    ...
    %16 = arith.muli %12, %15 {cfx.bb = 1 : i64, handshake.name = "muli0", sched_var = #cfx.sched_var<0>} : i32
    ...
    memref.store %16, %arg0[%18] {cfx.bb = 1 : i64, handshake.deps = #handshake<deps[["load0", 1, 1]]>, handshake.mem_interface = #handshake.mem_interface<LSQ: 0>, handshake.name = "store2", sched_var = #cfx.sched_var<0>} : memref<1000xi32>
