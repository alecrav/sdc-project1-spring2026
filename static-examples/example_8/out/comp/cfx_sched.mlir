module {
  cfx.func @example_8(%arg0: memref<1000xi32>, %arg1: i32) attributes {handshake.name = "func0"} {
    ...
    %14 = arith.muli %13, %6 {cfx.bb = 1 : i64, handshake.name = "muli0", sched_var = #cfx.sched_var<0>} : i32
    ...
    memref.store %14, %arg0[%17] {cfx.bb = 1 : i64, handshake.mem_interface = #handshake.mem_interface<LSQ: 0>, handshake.name = "store1", sched_var = #cfx.sched_var<0>} : memref<1000xi32>
    ...
    %23 = arith.muli %22, %6 {cfx.bb = 1 : i64, handshake.name = "muli1", sched_var = #cfx.sched_var<0>} : i32
    ...
    memref.store %23, %arg0[%27] {cfx.bb = 1 : i64, handshake.mem_interface = #handshake.mem_interface<LSQ: 0>, handshake.name = "store3", sched_var = #cfx.sched_var<0>} : memref<1000xi32>
    %28 = arith.addi %5, %9 {cfx.bb = 1 : i64, handshake.name = "addi0", sched_var = #cfx.sched_var<0>} : i32
    %29 = arith.cmpi ult, %28, %8 {cfx.bb = 1 : i64, handshake.name = "cmpi0", sched_var = #cfx.sched_var<0>} : i32
    %30 = cfx.cond_br cond = %29[when_true], input = %28 {cfx.bb = 1 : i64, handshake.name = "cond_br1", sched_var = #cfx.sched_var<0>} : i1, i32 -> i32
    %31 = cfx.cond_br cond = %29[when_true], input = %6 {cfx.bb = 1 : i64, handshake.name = "cond_br2", sched_var = #cfx.sched_var<0>} : i1, i32 -> i32
    %32 = cfx.cond_br cond = %29[when_true], input = %7 {cfx.bb = 1 : i64, handshake.name = "cond_br3", sched_var = #cfx.sched_var<0>} : i1, i0 -> i0
    %33 = cfx.cond_br cond = %29[when_false], input = %7 {cfx.bb = 1 : i64, handshake.name = "cond_br4", sched_var = #cfx.sched_var<0>} : i1, i0 -> i0
    cfx.return start = %33,  {cfx.bb = 2 : i64, handshake.name = "return1", sched_var = #cfx.sched_var<0>}
  }
}
